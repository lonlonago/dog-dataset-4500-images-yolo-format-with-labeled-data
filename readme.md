# Dog dataset (4500 images) YOLO format with labeled data.

# Body

Dog dataset, 4500 images in YOLO format, labeled. Just use it directly
It's suitable for target detection, image segmentation, algorithm optimization, model training, etc. There are plenty of dog images, which is convenient and time-saving
